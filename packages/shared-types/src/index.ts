...
export type CanvasImageRow   = Tables['canvas_images']['Row']
...
export type InsertCanvasImage      = Tables['canvas_images']['Insert']
...
export type UpdateCanvasImage      = Tables['canvas_images']['Update']
